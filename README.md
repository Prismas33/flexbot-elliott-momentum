...
- Todas as estratégias respeitam **RR mínimo de 3:1** (recompensa ≥ 3x o risco). Nas estratégias Momentum e OMDs os multiplicadores de ATR foram calibrados (stop 1.5× / TP 4.5× e stop 1.8× / TP 5.4×) para que o alvo natural já seja ≥3R — se nem assim chegar em 3R, o trade é descartado.
