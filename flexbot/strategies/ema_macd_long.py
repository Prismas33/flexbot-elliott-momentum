"""OMDs long-side confirmation logic."""
...
def ema_macd_confirm_long(
    ...
    *,
    ...
    rsi_zone_long_max: float = 29.0,
):
    """Confirma setup de compra para OMDs."""
    ...
    if rsi_val is None:
        ...
        if require_rsi_zone:
            rsi_zone_ok = rsi_val <= rsi_zone_long_max
            rsi_ok = rsi_zone_ok
        else:
    ...
    details = {
        ...
        "rsi_zone_long_max": rsi_zone_long_max,
        "score": score,
    }
    if confirmed:
